import * as LiveQuizCenter from "./js/admin/adminLiveQuiz.js";
import * as AttendanceSystem from "./js/admin/adminAttendance.js";
import { initAttendanceTab, populateAttendanceSubjects, populateAttendanceClasses, checkAndLoadAttendance } from "./js/admin/adminAttendance.js";
import * as TeacherProfile from "./js/admin/adminTeacherProfile.js";
import * as AttendanceAnalytics from "./js/admin/adminAttendanceAnalytics.js";
import * as QuizDocImport from "./js/admin/adminQuizDocImport.js";
import { setupAssignmentReminderContext, initAssignmentReminderTab, populateAssignmentReminderDropdowns, updateReminderSelectedCount } from "./js/admin/adminReminders.js";
    ...
    if (user) {
        ...
        try {
            ...
            if (userDoc.exists()) {
                ...
                setupAssignmentReminderContext({ getUserRole: () => userRole, getTeacherSubject: () => teacherSubject });
                if (AttendanceSystem && AttendanceSystem.setupAttendanceContext) {
                    AttendanceSystem.setupAttendanceContext({ getUserRole: () => userRole, getTeacherSubject: () => teacherSubject });
                }
            } else {
                userRole = "teacher";
            ...
            if (TeacherProfile && TeacherProfile.setCurrentTeacherProfileData) {
                TeacherProfile.setCurrentTeacherProfileData(currentTeacherProfileData);
                TeacherProfile.setupProfileContext({ profileData: currentTeacherProfileData, getUserRole: () => userRole, getTeacherSubject: () => teacherSubject });
            }
...
// --- LIVE QUIZ COMMAND CENTER & MONITORING MOVED TO ./js/admin/adminLiveQuiz.js ---
